...
window.onload = function () {
    ...
    async function fetchGotm() {
        const response = await fetch(`https://api.rawg.io/api/games?key=38f02c16bd3f4b208587775b9c332912&dates=2024-06-01,2024-07-31`);
    ...
    fetchGotm().then(game => {
        ...
        gameResult.forEach(game => {
            ...
            let container = document.getElementById("gamesotm");
            let htmlString = "";
